...
7. Если в connections встречается узел, которого нет в nodes — добавь ошибку в "errors": "Узел 'X' не найден в nodes". НЕ создавай этот узел в секции "nodes".
7a. НЕ создавай узлы, которых нет в исходном flow. Если в connections есть ссылка на узел,
отсутствующий в nodes — просто добавь ошибку в поле "errors", но НЕ включай этот узел в секцию "nodes".
